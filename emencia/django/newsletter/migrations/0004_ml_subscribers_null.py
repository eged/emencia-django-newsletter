...
class Migration(SchemaMigration):
    ...
    models = {
        ...
        'newsletter.mailinglist': {
            ...
            'subscribers': ('django.db.models.fields.related.ManyToManyField', [], {'blank': 'True', 'related_name': "'mailinglist_subscriber'", 'null': 'True', 'symmetrical': 'False', 'to': "orm['newsletter.Contact']"}),
